...
#
# Script generated by Vivado on Tue May 26 21:16:41 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bdesign_clock_core.sh
...
#
# Usage        : bdesign_clock_core.sh
#                bdesign_clock_core.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bdesign_clock_core.sh [-rerun]
#                bdesign_clock_core.sh [-reset_run]
#                bdesign_clock_core.sh [-clean]
#                bdesign_clock_core.sh [-reset_log]
#                bdesign_clock_core.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L xilinx_vip"
...
# script info
echo -e "bdesign_clock_core.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bdesign_clock_core.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L microblaze_v11_0_16 -L microblaze_riscv_v1_0_7 -L lmb_v10_v3_0_16 -L lmb_bram_if_cntlr_v4_0_27 -L blk_mem_gen_v8_4_12 -L axi_lite_ipif_v3_0_4 -L mdm_riscv_v1_0_7 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L axi_uartlite_v2_0_39 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bdesign_clock_core xil_defaultlib.bdesign_clock_core xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bdesign_clock_core -key {Behavioral:sim_1:Functional:bdesign_clock_core} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_128c.protoinst" -protoinst "protoinst_files/bdesign_clock_core.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bdesign_clock_core.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bdesign_clock_core.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bdesign_clock_core.sh [-help]\n\
Usage: bdesign_clock_core.sh [-step]\n\
Usage: bdesign_clock_core.sh [-lib_map_path]\n\
Usage: bdesign_clock_core.sh [-rerun]\n\
Usage: bdesign_clock_core.sh [-reset_run]\n\
Usage: bdesign_clock_core.sh [-clean]\n\
Usage: bdesign_clock_core.sh [-reset_log]\n\
Usage: bdesign_clock_core.sh [-keep_index]\n\
Usage: bdesign_clock_core.sh [-noclean_files]\n\n\
