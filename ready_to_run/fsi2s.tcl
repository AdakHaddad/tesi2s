...
#
# fsi2s.tcl: Tcl script for re-creating project 'nobufgmux_fix'
#
# Generated by Vivado on Thu Jun 11 20:14:18 +0700 2026
...
#
# 1. This project restoration tcl script (fsi2s.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/tesi2s/fix/ready_to_run/nobufgmux_fix - Copy/nobufgmux_fix.srcs/utils_1/imports/synth_1/bdesign_clock_core_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/tesi2s/iiradji/rtl/baud_rate_gen.v"
#    "C:/tesi2s/iiradji/rtl/fifo_rx.v"
#    "C:/tesi2s/iiradji/rtl/filter_auto.v"
#    "C:/tesi2s/iiradji/rtl/filter_top.v"
#    "C:/tesi2s/iiradji/rtl/rx.v"
#    "C:/tesi2s/iiradji/rtl/sevseg.v"
#    "C:/tesi2s/iiradji/rtl/tx.v"
#    "C:/tesi2s/fix/ready_to_run/ip_repo/pcm_serializer_1_0/hdl/pcm_serializer.v"
#    "C:/tesi2s/fix/ready_to_run/ip_repo/pcm_deserializer_1_0/hdl/pcm_deserializer.v"
#    "C:/tesi2s/fix/ready_to_run/ip_repo/filter_clock_divider_1_0/hdl/filter_clock_divider.v"
#    "C:/tesi2s/fix/ready_to_run/rtl/async_fifo_16_256.v"
#    "C:/tesi2s/iiradji/rtl/filter_biquad.v"
#    "C:/tesi2s/iiradji/rtl/filter_coeff.v"
#    "C:/tesi2s/fix/ready_to_run/ip_repo/i2s_filter_utils_1_0/hdl/i2s16_to_pcm16.v"
#    "C:/tesi2s/fix/ready_to_run/ip_repo/i2s_filter_utils_1_0/hdl/pcm16_to_i2s.v"
#    "C:/tesi2s/fix/ready_to_run/ip_repo/sample_rate_switch_1_0/hdl/sample_rate_switch.v"
#    "C:/tesi2s/fix/ready_to_run/rtl/top_audio.v"
#    "C:/nobufgmux.gen/sources_1/bd/bdesign_clock_core/hdl/bdesign_clock_core_wrapper.v"
#    "C:/tesi2s/fix/ready_to_run/proj/constrn.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/nobufgmux_fix - Copy/nobufgmux_fix.srcs/utils_1/imports/synth_1/bdesign_clock_core_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/baud_rate_gen.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/fifo_rx.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/filter_auto.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/filter_top.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/rx.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/sevseg.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/tx.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/pcm_serializer_1_0/hdl/pcm_serializer.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/pcm_deserializer_1_0/hdl/pcm_deserializer.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/filter_clock_divider_1_0/hdl/filter_clock_divider.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/rtl/async_fifo_16_256.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/filter_biquad.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/iiradji/rtl/filter_coeff.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/i2s_filter_utils_1_0/hdl/i2s16_to_pcm16.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/i2s_filter_utils_1_0/hdl/pcm16_to_i2s.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/sample_rate_switch_1_0/hdl/sample_rate_switch.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/rtl/top_audio.v"]"\
 "[file normalize "$origin_dir/../../../nobufgmux.gen/sources_1/bd/bdesign_clock_core/hdl/bdesign_clock_core_wrapper.v"]"\
 "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/proj/constrn.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../Users/tesi2s/fix/ready_to_run/ip_repo/myip_1_0"]"]"\
 "[file normalize "$origin_dir/../../../Users/tesi2s/fix/ready_to_run/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "nobufgmux_fix"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/nobufgmux_fix - Copy"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/myip_1_0"] [file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo"]" $obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/baud_rate_gen.v"
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/fifo_rx.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/filter_auto.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/filter_top.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/rx.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/sevseg.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/tx.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/pcm_serializer_1_0/hdl/pcm_serializer.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/pcm_deserializer_1_0/hdl/pcm_deserializer.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/filter_clock_divider_1_0/hdl/filter_clock_divider.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/rtl/async_fifo_16_256.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/filter_biquad.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/iiradji/rtl/filter_coeff.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/i2s_filter_utils_1_0/hdl/i2s16_to_pcm16.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/i2s_filter_utils_1_0/hdl/pcm16_to_i2s.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/ip_repo/sample_rate_switch_1_0/hdl/sample_rate_switch.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/rtl/top_audio.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../../nobufgmux.gen/sources_1/bd/bdesign_clock_core/hdl/bdesign_clock_core_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "bdesign_clock_core_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../../tesi2s/fix/ready_to_run/proj/constrn.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../tesi2s/fix/ready_to_run/proj/constrn.xdc"
set file [file normalize $file]
...
set file "synth_1/bdesign_clock_core_wrapper.dcp"
...
# Proc to create BD bdesign_clock_core
proc cr_bd_bdesign_clock_core { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name bdesign_clock_core
...
proc create_hier_cell_microblaze_riscv_0_local_memory { parentCell nameHier } {
  ...
  set i2s_ws_0 [ create_bd_port -dir O i2s_ws_0 ]
  set i2s_bclk_0 [ create_bd_port -dir O i2s_bclk_0 ]
  set i2s_data_0 [ create_bd_port -dir O i2s_data_0 ]
  set i2s_mclk_0 [ create_bd_port -dir O i2s_mclk_0 ]

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_0 ]
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {142.220} \
    CONFIG.CLKOUT1_PHASE_ERROR {114.989} \
    CONFIG.CLKOUT2_JITTER {189.486} \
    CONFIG.CLKOUT2_PHASE_ERROR {114.989} \
    CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {24.576} \
    CONFIG.CLKOUT2_USED {true} \
    CONFIG.CLKOUT3_JITTER {192.993} \
    CONFIG.CLKOUT3_PHASE_ERROR {114.989} \
    CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {22.579} \
    CONFIG.CLKOUT3_USED {true} \
    CONFIG.CLKOUT4_JITTER {266.636} \
    CONFIG.CLKOUT4_PHASE_ERROR {126.282} \
    CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {5.120} \
    CONFIG.CLKOUT4_USED {false} \
    CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {7.625} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {7.625} \
    CONFIG.MMCM_CLKOUT1_DIVIDE {31} \
    CONFIG.MMCM_CLKOUT2_DIVIDE {34} \
  ...
  # Create instance: i2s_dds_0, and set properties
  set i2s_dds_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:i2s_dds:1.0 i2s_dds_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins i2s_dds_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out5  [get_bd_pins clk_wiz_0/clk_out1] \
  ...
  [get_bd_pins i2s_dds_0/audio_clk] \
  [get_bd_pins i2s_dds_0/s00_axi_aclk]
  connect_bd_net -net clk_wiz_0_locked  [get_bd_pins clk_wiz_0/locked] \
  [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  connect_bd_net -net i2s_dds_0_i2s_bclk  [get_bd_pins i2s_dds_0/i2s_bclk] \
  [get_bd_ports i2s_bclk_0]
  connect_bd_net -net i2s_dds_0_i2s_data  [get_bd_pins i2s_dds_0/i2s_data] \
  [get_bd_ports i2s_data_0]
  connect_bd_net -net i2s_dds_0_i2s_mclk  [get_bd_pins i2s_dds_0/i2s_mclk] \
  [get_bd_ports i2s_mclk_0]
  connect_bd_net -net i2s_dds_0_i2s_ws  [get_bd_pins i2s_dds_0/i2s_ws] \
  [get_bd_ports i2s_ws_0]
  ...
  [get_bd_pins i2s_dds_0/s00_axi_aresetn]
  connect_bd_net -net sys_clock_1  [get_bd_ports sys_clock] \
  [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  assign_bd_address -offset 0x04060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs i2s_dds_0/S00_AXI/S00_AXI_reg] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Addressing View_Layout":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port usb_uart -pg 1 -lvl 4 -x 1020 -y 220 -defaultsOSRD
preplace port port-id_i2s_ws_0 -pg 1 -lvl 4 -x 1020 -y 110 -defaultsOSRD
preplace port port-id_i2s_bclk_0 -pg 1 -lvl 4 -x 1020 -y 80 -defaultsOSRD
preplace port port-id_i2s_data_0 -pg 1 -lvl 4 -x 1020 -y 140 -defaultsOSRD
preplace port port-id_i2s_mclk_0 -pg 1 -lvl 4 -x 1020 -y 50 -defaultsOSRD
preplace inst microblaze_riscv_0 -pg 1 -lvl 1 -x 280 -y 110 -defaultsOSRD
preplace inst microblaze_riscv_0_local_memory -pg 1 -lvl 2 -x 670 -y 100 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 670 -y 220 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 3 -x 900 -y 220 -defaultsOSRD
preplace inst i2s_dds_0 -pg 1 -lvl 3 -x 900 -y 90 -defaultsOSRD
preplace netloc i2s_dds_0_i2s_bclk 1 3 1 NJ 80
preplace netloc i2s_dds_0_i2s_data 1 3 1 1000J 120n
preplace netloc i2s_dds_0_i2s_mclk 1 3 1 1000J 50n
preplace netloc i2s_dds_0_i2s_ws 1 3 1 1000J 100n
preplace netloc axi_smc_M00_AXI 1 2 1 800 90n
preplace netloc axi_smc_M01_AXI 1 2 1 NJ 220
preplace netloc axi_uartlite_0_UART 1 3 1 NJ 220
preplace netloc microblaze_riscv_0_M_AXI_DP 1 1 1 540 130n
preplace netloc microblaze_riscv_0_debug 1 0 1 N 120
preplace netloc microblaze_riscv_0_dlmb_1 1 1 1 N 90
preplace netloc microblaze_riscv_0_ilmb_1 1 1 1 N 110
levelinfo -pg 1 0 280 670 900 1020
pagesize -pg 1 -db -bbox -sgen 0 0 1140 300
",
   "Addressing View_ScaleFactor":"1.5",
   "Addressing View_TopLeft":"-58,-173",
   "Clocking and Reset View_ExpandedHierarchyInLayout":"",
   "Clocking and Reset View_Layers":"/sys_clock_1:true|/clk_wiz_0_clk_out5:true|/mdm_1_debug_sys_rst:true|/reset_1:true|/rst_clk_wiz_0_100M_peripheral_aresetn:true|/rst_clk_wiz_0_100M_bus_struct_reset:true|/rst_clk_wiz_0_100M_mb_reset:true|",
   "Clocking and Reset View_Layout":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port usb_uart -pg 1 -lvl 4 -x 1050 -y 140 -defaultsOSRD
preplace port port-id_sys_clock -pg 1 -lvl 0 -x 0 -y 640 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x 0 -y 460 -defaultsOSRD
preplace port port-id_i2s_ws_0 -pg 1 -lvl 4 -x 1050 -y 110 -defaultsOSRD
preplace port port-id_i2s_bclk_0 -pg 1 -lvl 4 -x 1050 -y 20 -defaultsOSRD
preplace port port-id_i2s_data_0 -pg 1 -lvl 4 -x 1050 -y 50 -defaultsOSRD
preplace port port-id_i2s_mclk_0 -pg 1 -lvl 4 -x 1050 -y 80 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 130 -y 630 -defaultsOSRD
preplace inst microblaze_riscv_0 -pg 1 -lvl 3 -x 810 -y 460 -defaultsOSRD
preplace inst microblaze_riscv_0_local_memory -pg 1 -lvl 3 -x 810 -y 590 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 1 -x 130 -y 520 -defaultsOSRD
preplace inst rst_clk_wiz_0_100M -pg 1 -lvl 2 -x 410 -y 500 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 810 -y 70 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 3 -x 810 -y 190 -defaultsOSRD
preplace inst i2s_dds_0 -pg 1 -lvl 3 -x 810 -y 320 -defaultsOSRD
preplace netloc clk_wiz_0_clk_out5 1 1 2 250 580 580
preplace netloc mdm_1_debug_sys_rst 1 1 1 NJ 520
preplace netloc reset_1 1 0 2 20 460 240J
preplace netloc rst_clk_wiz_0_100M_bus_struct_reset 1 2 1 570 500n
preplace netloc rst_clk_wiz_0_100M_mb_reset 1 2 1 N 480
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 2 1 590 80n
preplace netloc sys_clock_1 1 0 1 NJ 640
levelinfo -pg 1 0 130 410 810 1050
pagesize -pg 1 -db -bbox -sgen -110 0 1170 700
",
   "Clocking and Reset View_ScaleFactor":"1.39424",
   "Clocking and Reset View_TopLeft":"-152,2",
   "Color Coded_ExpandedHierarchyInLayout":"",
   "Color Coded_Layout":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port usb_uart -pg 1 -lvl 6 -x 1660 -y 230 -defaultsOSRD
preplace port port-id_sys_clock -pg 1 -lvl 0 -x 0 -y 510 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x 0 -y 410 -defaultsOSRD
preplace port port-id_i2s_ws_0 -pg 1 -lvl 6 -x 1660 -y 110 -defaultsOSRD
preplace port port-id_i2s_bclk_0 -pg 1 -lvl 6 -x 1660 -y 80 -defaultsOSRD
preplace port port-id_i2s_data_0 -pg 1 -lvl 6 -x 1660 -y 140 -defaultsOSRD
preplace port port-id_i2s_mclk_0 -pg 1 -lvl 6 -x 1660 -y 50 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 110 -y 500 -defaultsOSRD
preplace inst microblaze_riscv_0 -pg 1 -lvl 3 -x 850 -y 250 -defaultsOSRD
preplace inst microblaze_riscv_0_local_memory -pg 1 -lvl 4 -x 1270 -y 260 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 2 -x 380 -y 250 -defaultsOSRD
preplace inst rst_clk_wiz_0_100M -pg 1 -lvl 2 -x 380 -y 430 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 4 -x 1270 -y 80 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 5 -x 1530 -y 240 -defaultsOSRD
preplace inst i2s_dds_0 -pg 1 -lvl 5 -x 1530 -y 90 -defaultsOSRD
preplace netloc clk_wiz_0_clk_out5 1 1 4 200 330 560 140 1140 170 1410
preplace netloc clk_wiz_0_locked 1 1 1 210 470n
preplace netloc i2s_dds_0_i2s_bclk 1 5 1 NJ 80
preplace netloc i2s_dds_0_i2s_data 1 5 1 1640J 120n
preplace netloc i2s_dds_0_i2s_mclk 1 5 1 1640J 50n
preplace netloc i2s_dds_0_i2s_ws 1 5 1 1640J 100n
preplace netloc mdm_1_debug_sys_rst 1 1 2 210 320 550
preplace netloc reset_1 1 0 2 20 410 NJ
preplace netloc rst_clk_wiz_0_100M_bus_struct_reset 1 2 2 570J 150 1120
preplace netloc rst_clk_wiz_0_100M_mb_reset 1 2 1 580 280n
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 2 3 590J 160 1130 160 1420
preplace netloc sys_clock_1 1 0 1 NJ 510
preplace netloc axi_smc_M00_AXI 1 4 1 N 60
preplace netloc axi_smc_M01_AXI 1 4 1 1400 80n
preplace netloc axi_uartlite_0_UART 1 5 1 NJ 230
preplace netloc microblaze_riscv_0_M_AXI_DP 1 3 1 1110 60n
preplace netloc microblaze_riscv_0_debug 1 2 1 N 240
preplace netloc microblaze_riscv_0_dlmb_1 1 3 1 N 230
preplace netloc microblaze_riscv_0_ilmb_1 1 3 1 N 250
levelinfo -pg 1 0 110 380 850 1270 1530 1660
pagesize -pg 1 -db -bbox -sgen -110 0 1780 590
",
   "Color Coded_ScaleFactor":"1.00903",
   "Color Coded_TopLeft":"-107,-185",
   "Default View_Layers":"/rst_clk_wiz_0_100M_bus_struct_reset:true|/mdm_1_debug_sys_rst:true|/reset_1:true|/clk_wiz_0_clk_out2:true|/clk_wiz_0_clk_out3:true|/rst_clk_wiz_0_100M_peripheral_aresetn:true|/sys_clock_1:true|/rst_clk_wiz_0_100M_mb_reset:true|/microblaze_riscv_0_Clk:true|/clk_wiz_0_clk_out5:true|",
   "Default View_ScaleFactor":"1.00903",
   "Default View_TopLeft":"111,52",
   ...
   "Grouping and No Loops_Layers":"/mdm_1_debug_sys_rst:true|/sys_clock_1:true|/clk_wiz_0_clk_out5:true|/reset_1:true|/rst_clk_wiz_0_100M_peripheral_aresetn:true|/rst_clk_wiz_0_100M_bus_struct_reset:true|/rst_clk_wiz_0_100M_mb_reset:true|",
   "Grouping and No Loops_ScaleFactor":"0.671141",
   "Grouping and No Loops_TopLeft":"-128,-237",
   "Interfaces View_ExpandedHierarchyInLayout":"",
   "Interfaces View_Layers":"/rst_clk_wiz_0_100M_bus_struct_reset:false|/mdm_1_debug_sys_rst:false|/reset_1:false|/clk_wiz_0_clk_out2:false|/clk_wiz_0_clk_out3:false|/rst_clk_wiz_0_100M_peripheral_aresetn:false|/sys_clock_1:false|/rst_clk_wiz_0_100M_mb_reset:false|/microblaze_riscv_0_Clk:false|/clk_wiz_0_clk_out5:false|",
   "Interfaces View_Layout":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port usb_uart -pg 1 -lvl 5 -x 1220 -y 190 -defaultsOSRD
preplace port port-id_i2s_ws_0 -pg 1 -lvl 5 -x 1220 -y 110 -defaultsOSRD
preplace port port-id_i2s_bclk_0 -pg 1 -lvl 5 -x 1220 -y 20 -defaultsOSRD
preplace port port-id_i2s_data_0 -pg 1 -lvl 5 -x 1220 -y 50 -defaultsOSRD
preplace port port-id_i2s_mclk_0 -pg 1 -lvl 5 -x 1220 -y 80 -defaultsOSRD
preplace inst microblaze_riscv_0 -pg 1 -lvl 2 -x 480 -y 80 -defaultsOSRD
preplace inst microblaze_riscv_0_local_memory -pg 1 -lvl 3 -x 870 -y 70 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 1 -x 110 -y 90 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 870 -y 190 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 4 -x 1100 -y 190 -defaultsOSRD
preplace inst i2s_dds_0 -pg 1 -lvl 4 -x 1100 -y 90 -defaultsOSRD
preplace netloc axi_smc_M00_AXI 1 3 1 1000J 90n
preplace netloc axi_smc_M01_AXI 1 3 1 NJ 190
preplace netloc axi_uartlite_0_UART 1 4 1 NJ 190
preplace netloc microblaze_riscv_0_M_AXI_DP 1 2 1 740 100n
preplace netloc microblaze_riscv_0_debug 1 1 1 N 90
preplace netloc microblaze_riscv_0_dlmb_1 1 2 1 N 60
preplace netloc microblaze_riscv_0_ilmb_1 1 2 1 N 80
levelinfo -pg 1 0 110 480 870 1100 1220
pagesize -pg 1 -db -bbox -sgen 0 0 1340 270
",
   "Interfaces View_ScaleFactor":"1.39809",
   "Interfaces View_TopLeft":"-23,-212",
   "Interrupt and AXI-4 Lite_ExpandedHierarchyInLayout":"",
   "Interrupt and AXI-4 Lite_Layers":"/rst_clk_wiz_0_100M_bus_struct_reset:false|/mdm_1_debug_sys_rst:false|/reset_1:false|/clk_wiz_0_clk_out2:false|/clk_wiz_0_clk_out3:false|/rst_clk_wiz_0_100M_peripheral_aresetn:false|/sys_clock_1:false|/rst_clk_wiz_0_100M_mb_reset:false|/microblaze_riscv_0_Clk:false|/clk_wiz_0_clk_out5:false|",
   "Interrupt and AXI-4 Lite_Layout":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port usb_uart -pg 1 -lvl 4 -x 1000 -y 140 -defaultsOSRD
preplace port port-id_i2s_ws_0 -pg 1 -lvl 4 -x 1000 -y 110 -defaultsOSRD
preplace port port-id_i2s_bclk_0 -pg 1 -lvl 4 -x 1000 -y 20 -defaultsOSRD
preplace port port-id_i2s_data_0 -pg 1 -lvl 4 -x 1000 -y 50 -defaultsOSRD
preplace port port-id_i2s_mclk_0 -pg 1 -lvl 4 -x 1000 -y 80 -defaultsOSRD
preplace inst microblaze_riscv_0 -pg 1 -lvl 1 -x 260 -y 80 -defaultsOSRD
preplace inst microblaze_riscv_0_local_memory -pg 1 -lvl 1 -x 260 -y 190 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 2 -x 650 -y 190 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 650 -y 80 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 3 -x 880 -y 160 -defaultsOSRD
preplace inst i2s_dds_0 -pg 1 -lvl 3 -x 880 -y 60 -defaultsOSRD
preplace netloc axi_smc_M00_AXI 1 2 1 NJ 60
preplace netloc axi_smc_M01_AXI 1 2 1 780J 80n
preplace netloc microblaze_riscv_0_M_AXI_DP 1 1 1 N 80
levelinfo -pg 1 0 260 650 880 1000
pagesize -pg 1 -db -bbox -sgen 0 0 1120 240
",
   "Interrupt and AXI-4 Lite_ScaleFactor":"1.5",
   "Interrupt and AXI-4 Lite_TopLeft":"-63,-197",
   "No Loops_ScaleFactor":"0.649795",
   "No Loops_TopLeft":"-128,-251",
   "Reduced Jogs_Layers":"/rst_clk_wiz_0_100M_bus_struct_reset:true|/mdm_1_debug_sys_rst:true|/reset_1:true|/clk_wiz_0_clk_out2:true|/clk_wiz_0_clk_out3:true|/rst_clk_wiz_0_100M_peripheral_aresetn:true|/sys_clock_1:true|/rst_clk_wiz_0_100M_mb_reset:true|/microblaze_riscv_0_Clk:true|",
   "Reduced Jogs_ScaleFactor":"0.65427",
   "Reduced Jogs_TopLeft":"-128,-245",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port usb_uart -pg 1 -lvl 6 -x 1680 -y 230 -defaultsOSRD
preplace port port-id_sys_clock -pg 1 -lvl 0 -x -10 -y 510 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x -10 -y 410 -defaultsOSRD
preplace port port-id_i2s_ws_0 -pg 1 -lvl 6 -x 1680 -y 110 -defaultsOSRD
preplace port port-id_i2s_bclk_0 -pg 1 -lvl 6 -x 1680 -y 80 -defaultsOSRD
preplace port port-id_i2s_data_0 -pg 1 -lvl 6 -x 1680 -y 140 -defaultsOSRD
preplace port port-id_i2s_mclk_0 -pg 1 -lvl 6 -x 1680 -y 50 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 110 -y 500 -defaultsOSRD
preplace inst microblaze_riscv_0 -pg 1 -lvl 3 -x 850 -y 250 -defaultsOSRD
preplace inst microblaze_riscv_0_local_memory -pg 1 -lvl 4 -x 1270 -y 260 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 2 -x 390 -y 250 -defaultsOSRD
preplace inst rst_clk_wiz_0_100M -pg 1 -lvl 2 -x 390 -y 430 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 4 -x 1270 -y 80 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 5 -x 1540 -y 240 -defaultsOSRD
preplace inst i2s_dds_0 -pg 1 -lvl 5 -x 1540 -y 90 -defaultsOSRD
preplace netloc clk_wiz_0_clk_out5 1 1 4 210 330 570 140 1140 170 1410
preplace netloc clk_wiz_0_locked 1 1 1 220 470n
preplace netloc i2s_dds_0_i2s_bclk 1 5 1 NJ 80
preplace netloc i2s_dds_0_i2s_data 1 5 1 1660J 120n
preplace netloc i2s_dds_0_i2s_mclk 1 5 1 1660J 50n
preplace netloc i2s_dds_0_i2s_ws 1 5 1 1660J 100n
preplace netloc mdm_1_debug_sys_rst 1 1 2 220 320 560
preplace netloc reset_1 1 0 2 10 410 NJ
preplace netloc rst_clk_wiz_0_100M_bus_struct_reset 1 2 2 580J 150 1110
preplace netloc rst_clk_wiz_0_100M_mb_reset 1 2 1 590 280n
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 2 3 600J 160 1130 160 1420
preplace netloc sys_clock_1 1 0 1 NJ 510
preplace netloc axi_smc_M00_AXI 1 4 1 N 60
preplace netloc axi_smc_M01_AXI 1 4 1 1400 80n
preplace netloc axi_uartlite_0_UART 1 5 1 NJ 230
preplace netloc microblaze_riscv_0_M_AXI_DP 1 3 1 1100 60n
preplace netloc microblaze_riscv_0_debug 1 2 1 N 240
preplace netloc microblaze_riscv_0_dlmb_1 1 3 1 N 230
preplace netloc microblaze_riscv_0_ilmb_1 1 3 1 N 250
levelinfo -pg 1 -10 110 390 850 1270 1540 1680
pagesize -pg 1 -db -bbox -sgen -130 0 1800 590
"
}
...
# End of cr_bd_bdesign_clock_core()

cr_bd_bdesign_clock_core ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files bdesign_clock_core.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files bdesign_clock_core.bd ] 
set_property IS_ENABLED "1" [get_files bdesign_clock_core.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files bdesign_clock_core.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files bdesign_clock_core.bd ] 
set_property PFM_NAME "" [get_files bdesign_clock_core.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files bdesign_clock_core.bd ] 
set_property SYNTH_CHECKPOINT_MODE "None" [get_files bdesign_clock_core.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files bdesign_clock_core.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files bdesign_clock_core.bd ] 
set_property USED_IN_SIMULATION "1" [get_files bdesign_clock_core.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files bdesign_clock_core.bd ] 
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/bdesign_clock_core_wrapper.dcp" -objects $obj
