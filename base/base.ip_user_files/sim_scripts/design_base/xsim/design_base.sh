...
#
# Script generated by Vivado on Wed May 13 03:11:49 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_base.sh
...
#
# Usage        : design_base.sh
#                design_base.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_base.sh [-rerun]
#                design_base.sh [-reset_run]
#                design_base.sh [-clean]
#                design_base.sh [-reset_log]
#                design_base.sh [-help]
#
...
# script info
echo -e "design_base.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_base.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_base.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_base.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_base.sh [-help]\n\
Usage: design_base.sh [-step]\n\
Usage: design_base.sh [-lib_map_path]\n\
Usage: design_base.sh [-rerun]\n\
Usage: design_base.sh [-reset_run]\n\
Usage: design_base.sh [-clean]\n\
Usage: design_base.sh [-reset_log]\n\
Usage: design_base.sh [-keep_index]\n\
Usage: design_base.sh [-noclean_files]\n\n\
