...
#create_clock -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports sys_clk]
...
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 } [get_ports rx];#Sch name = JA2
...
#set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports din];#Sch name = JB3
